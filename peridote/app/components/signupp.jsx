...
import { X, User, Mail, Lock, Apple } from 'lucide-react';
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4 sm:p-6">
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 sm:p-8 border-b border-gray-100">
            <h2 className="text-2xl sm:text-3xl font-bold text-black" style={{ fontFamily: 'var(--font-poppins)' }}>
              Create Account
            </h2>
            <button
              onClick={onClose}
          ...
          <div className="p-6 sm:p-8">
            {/* Subtitle */}
            <p className="text-gray-600 text-base sm:text-lg mb-6" style={{ fontFamily: 'var(--font-poppins)' }}>
