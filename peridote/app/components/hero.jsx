  ...
  return (
    <section className="relative w-full h-[560px] sm:h-[900px] md:h-[500px] lg:h-[570px] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-between max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
        ...
        {/* Choose Component - Reduced space on mobile */}
          ...
          <div className="w-full" style={{ fontFamily: 'Manrope, sans-serif' }}>
            ...
            {error && (
              <div className="mb-4 bg-red-50 border border-red-200 rounded-lg p-4 flex gap-3">
                ...
                <div>
                  <p className="font-semibold text-red-900" style={{ fontFamily: 'Manrope, sans-serif' }}>Error</p>
                  ...
                  <div className="space-y-3">
                    <div className="space-y-3">
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <label className="block text-xs font-medium text-gray-700 mb-1" style={{ fontFamily: 'Manrope, sans-serif' }}>
                            From
                          </label>
                          <div className="relative">
